  ...
  const promoterQuestions = {
    tj: [
      ...
      },
      {
        ...
        answer: 'Ҳамаи комиссияҳо ҳамчун холҳо дода мешаванд. Холҳоро шумо метавонед мустақиман дар Мағозаи Холҳо истифода баред. Танҳо шарикони тарғиботии платформа метавонанд дархости бардошти комиссия диҳанд. Барои шарики тарғиботӣ шудан, бо хидмати мизоҷон тамос гиред.',
      },
      {
    ...
    zh: [
      ...
      {
        question: '如何提取佣金？',
        answer: '所有佣金都以积分形式发放，积分可以直接在积分商城购物消费。只有平台推广合伙人可以申请将佣金提现。成为平台推广合伙人的具体要求可以咨询客服。',
      },
      {
        question: '可以邀请多少人？',
    ...
    ru: [
      ...
      },
      {
        ...
        answer: 'Все комиссии выплачиваются в виде баллов. Баллы можно использовать напрямую для покупок в Магазине Баллов. Только партнёры-промоутеры платформы могут подать заявку на вывод комиссии. Для получения статуса партнёра-промоутера обратитесь в службу поддержки.',
      },
      {
